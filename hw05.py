        ...
        while z.parent.color is 1:
            if z.parent == z.parent.parent.leftChild:
                ...
                if y.color is 1:
                    ...
                    z.parent.color = 0
                    z.parent.parent = 1
                    self._rotateleftChild(z.parent.parent)
        self._root.color = 0
    ...
    for filename in filenames:
        ...
        for line in lines:
            if int(line) > 0 :
                ...
                break
        f.close()
        print("insert:" + str(insertion_count))
        print("miss:" + str(miss_deleted))
        print("delete: " + str(deletion_count))
...
if __name__ == "__main__":
    rbt = RBTree()
    search_fileread()
    print ("total: " + str(rbt.treeSize(rbt.root,size=0)))
    print("nb : " + "")
    print("bh: " + "")
    print(rbt.inorder)
